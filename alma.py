...
month_old_names = [
    None,
    "Januarius &ndash; Thors-månad",
    "Februarius &ndash; Göjemånad",
    "Martius &ndash; Wårmånad",
    "Aprilis &ndash; Gräsmånad",
    "Majus &ndash; Blomstermånad",
    "Junius &ndash; Sommarmånad",
    "Julius &ndash; Hömånad",
    "Augustus &ndash; Skördemånad",
    "September &ndash; Höstmånad",
    "October &ndash; Slagtmånad",
    "November &ndash; Wintermånad",
    "December &ndash; Julmånad",
]
...
def easter_sunday(year):
    ...
    if year == 1802 or year == 1805 or year == 1818:
        jd += 7
    elif year == 1744:
        jd -= 7
...
class DayCal:
    ...
    def __init__(self, jd, mark_as_today=False):
        ...
        (self.y, self.m, self.d) = self.jd.GetYMD()

        (self.wyear, self.week, self.wday) = self.jd.GetYWD()
    ...
    def add_info(self, dayclass, flag, name):
        ...
        if dayclass <= RED:
            self.red = True
        if name:
            self.day_names.append(DayName(name, dayclass))
        if flag:
            self.flag_day = True
    ...
    def moonphase_name(self):
        if self.moonphase is None:
            ...
            return ["Nymåne", "Första kvarteret", "Fullmåne", "Sista kvarteret"][
                self.moonphase
            ]
            ...
            for dayname in self.day_names:
                if dayname.dayclass == dayclass:
                    if dayname.is_red:
                        ...
                        colour = "black"
                    redblack.append(
                        '<SPAN CLASS="vname %s">%s</SPAN>' % (colour, dayname.name)
                    )
    ...
    def html_vertical(self, f, in_week_cal=False, for_printing=False):
        ...
        if self.d == 1 or self.wpos == 1:
            if in_week_cal:
                ...
                wtext = (
                    '<A CLASS="hidelink" HREF="?year=%d&month=%d&type=vertical">%s</A>'
                    % (self.y, self.m, month_names[self.m][:3])
                )
            else:
                ...
                if self.y >= 1973:
                    ...
                    wtext = (
                        '<A CLASS="hidelink" HREF="?year=%d&week=%d&type=week">%s</A>'
                        % (self.wyear, self.week, self.week)
                    )
                else:
                    wtext = "&nbsp;"
        ...
        if self.moonphase is not None:
            f.write(
                '<IMG SRC="moonphase%d.gif" ALT="%s" TITLE="%s">'
                % (self.moonphase, self.moonphase_name(), self.moonphase_name())
            )
            empty = False
        ...
        if redblack_string and name_string:
            f.write("<BR>")
        f.write(name_string)
        f.write("&nbsp;</TD>")
    ...
    def html_day(self, f):
        ...
        # Veckodag
        f.write(
            '<DIV CLASS="dwday %s">%s v%d</DIV>' % (colour, self.wday_name, self.week)
        )
        # Flaggdagar och månfaser
            ...
            self.place_name_day_names(
                ...
                [
                    ...
                    (
                        ...
                        26,
                        ["Teresia"],
                    ),  # Teresia och Engelbrekt byter plats med varandra.
            ...
            self.place_name_day_names(
                ...
                [
                    ...
                    (
                        ...
                        17,
                        ["Rebecka"],
                    ),  # Rebecca (två av tre kalendrar bytte till ck 1877)
                    (1872, 5, 18, ["Erik"]),  # Eric
                    ...
                    (
                        ...
                        21,
                        ["Matteus"],
                    ),  # Vissa modernare kalendrar hade denna 1897.
                    ...
                    (
                        ...
                        22,
                        ["Severus"],
                    ),  # (5) Därefter lite olika hos olika utgivare, men w är avtagande.
                    ...
                    (
                        ...
                        23,
                        ["Severin"],
                    ),  # Lite blandat hos olika utgivare 1840-tal och framåt.
                    ...
                    (
                        ...
                        10,
                        ["Mårthen Luther"],
                    ),  # (3) (lite osäkert, 1821 o 1829 förk. "Mårt. Luther")
                    ...
                    (
                        ...
                        11,
                        ["Mårthen biskop"],
                    ),  # (3) (lite osäkert, 1821 o 1829 förk. "Mårt. biskop")
                    ...
                    (
                        ...
                        12,
                        27,
                        ["Johannes Evangelistus"],
                    ),  # Ersätter Johannes Ewangelistus
    ...
    def place_names(self):
        ...
        for from_year, to_year, m, d, dayclass, flag, name in [
            ...
            (
                ...
                True,
                "Första maj",
            ),  # 1939 blev 1 maj allmän helgdag.
            ...
            (
                ...
                False,
                "Annandag jul",
            ),  # 1921 står denna form. 1925 har de med Stefanus med.
            (
                1924,
                1982,
                12,
            ...
            ),  # Formen fanns kvar 1977, men ej 1983 måste undersökas mera.
            ...
            (
                ...
                True,
                "FN-dagen",
            ),  # Infördes i SFS1982:270 den 29 april 1982.
            (
                1939,
                None,
                11,
            ...
            (
                ...
                BLACK,
                True,
                "Minnesdag för demokratins genombrott",
            ),  # Tillfällig flaggdag 2018, enligt 2017/18:KU28
            (
                2023,
                2023,
                9,
                ...
                BLACK,
                True,
                "50-årsdagen av kung Carl XVI Gustafs trontillträde",
            ),  # Tillfällig flaggdag 2023, enligt 2022/23:KU41
            (
                2024,
                2024,
                6,
            ...
            ),  # Val till Europaparlamentet är flaggdag sedan 1 april 2023.
            ...
            (
                ...
                BLACK,
                True,
                "Konungens och kronprinsens namnsdag",
            ),  # namnsdag "Gustav". Ser styltigt upp att ha dem separat.
            ...
            if from_year is not None and self.year < from_year:
                continue
            if to_year is not None and self.year > to_year:
                continue
        ...
        if 1800 <= self.year < 1984:
            ...
            # 1 böndagen / Botdagen
            bd1 = JD(
                self.year, forsta_bondagen[self.year][0], forsta_bondagen[self.year][1]
            )
            if self.year < 1945:
            ...
            bd2 = JD(
                self.year, andra_bondagen[self.year][0], andra_bondagen[self.year][1]
            )
            if self.year < 1945:
            ...
            bd3 = JD(
                self.year, tredje_bondagen[self.year][0], tredje_bondagen[self.year][1]
            )
            if self.year < 1945:
                self.add_info_jd(bd3, RED, False, "3 böndagen")
            else:
                self.add_info_jd(
                    bd3, RED, False, "Missionsdagen (3 böndagen)"
                )  # fast 1983 står det bara "Missionsdagen".
                se3_stoppers.append(bd3)

            # 4 böndagen / Tacksägelsedagen
            bd4 = JD(
                self.year, fjarde_bondagen[self.year][0], fjarde_bondagen[self.year][1]
            )
            if self.year < 1945:
        ...
        for jd, name in [(pd - 63, "Septuagesima"), (pd - 56, "Sexagesima")]:
        ...
        if self.year < 1901:  # Ändrades mellan 1900 och 1905, troligen 1901.
            ...
            self.add_info_jd(
                jmk, RED, False, "Marie kyrkogångsdag eller Kyndelsmässodagen"
            )
        else:
            self.add_info_jd(
                jmk, RED, False, "Jungfru Marie Kyrkogångsdag eller Kyndelsmässodagen"
            )
        ...
        if (
            self.year < 1901
        ):  # Denna form fanns kvar 1900, men var borta 1905. Stora ändringar gjordes 1901.
        ...
        if self.year > 1981:
            se3_stoppers.append(
                hmd
            )  # Åtminstone fram till 1972 visades båda. I kalendrar 1982-1983 visas bara "Mikaels dag".
...
class MonthCal:
    ...
    def __init__(self, yearcal, month):
        ...
        self.num_days = [None, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][
            self.month
        ]
    ...
    def html_tabular(self, f, for_printing=False, high=False):
        ...
        for dc in self.generate():
            ...
            if dc.d == 1 or dc.wpos == 1:
                ...
                if dc.y >= 1973:
                    wtext = (
                        '<A CLASS="hidelink" HREF="?year=%d&week=%d&type=week">%d</A>'
                        % (dc.wyear, dc.week, dc.week)
                    )
                else:
                    wtext = "&nbsp;"
